...
class LocalTemperatureHumidityAccessory implements AccessoryPlugin {
	 ...
	 */
	getServices(): Service[] {
		const services: Array<Service> = new Array<Service>(this.informationService, this.temperatureService);
		if (this.disableHumidity !== true) {
